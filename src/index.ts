...
import { registerReStdlib } from './stdlib/re.js';
import { registerEncStdlib } from './stdlib/enc.js';
import { registerCryptoStdlib } from './stdlib/crypto-mod.js';
import { registerUuidStdlib } from './stdlib/uuid.js';
import { registerLogStdlib } from './stdlib/log.js';
...
function createGlobalEnv(): Environment {
  ...
  registerReStdlib(env);
  registerEncStdlib(env);
  registerCryptoStdlib(env);
  registerUuidStdlib(env);
  registerLogStdlib(env);
